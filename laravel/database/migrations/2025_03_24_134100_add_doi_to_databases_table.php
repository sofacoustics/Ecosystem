...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('databases', function (Blueprint $table) {
					...
					$table->unsignedInteger('radar_status')->nullable(); // null or 0: nothing happened with RADAR yet; 1: DOI assigned; 2: Requested publication, curator notified; 3: Database persistently published.
		});
    }
