...
class DatafileSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Datafile::create(array('name' => 'dtf b_nh4', 'location' => NULL, 'dataset_id' => 3, 'datasetdef_id' => 6 ));
        Datafile::create(array('name' => 'hrtf b_nh4', 'location' => NULL, 'dataset_id' => 3, 'datasetdef_id' => 7 ));
    }
}
