...
labelUnits = strrep(Obj.RoomCorners_Units, 'metre', 'm');
Obj=SOFAremoveVariable(Obj,'RoomVolume');
Obj=SOFAremoveVariable(Obj,'RoomCorners');
...
switch Obj0.GLOBAL_SOFAConventions
    ...
    case {'SimpleFreeFieldHRTF','SimpleFreeFieldHRIR','SingleRoomDRIR','FreeFieldDirectivityTF','GeneralFIR','GeneralTFE','FreeFieldHRIR','FreeFieldHRTF','GeneralTF-E','SingleRoomMIMOSRIR','SingleRoomSRIR'}
        ...
        x = [Obj.RoomCornerA(index,1), Obj.RoomCornerB(index,1)];
        y = [Obj.RoomCornerA(index,2), Obj.RoomCornerB(index,2)];
        z = [Obj.RoomCornerA(index,3), Obj.RoomCornerB(index,3)];
        ...
        legend(legendEntries,legendDescription,'Location','best');
        % xlabel(['x ('  ')']);
