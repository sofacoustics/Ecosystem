<div>
		...
		@if($spectrumEs)
			<tbody>
				<tr class="py-2 border">
					@if($counter)
						<td class="px-6 py-4 whitespace-normal"><b>Domain:</b> Amplitude spectral<br><b>Frequency axis:</b> Logarithmic<br> 
					...
					@else
						<td class="px-6 py-4 whitespace-normal"><b>Domain:</b> Amplitude spectral<br><b>Frequency axis:</b> Linear<br> 
			...
			<tr>
				<td colspan="3" class="px-6 py-4 whitespace-normal"><b>Note:</b> For improved presentation, the spectra shown were 16 times oversampled.<br> 
			</td>
		</tr>
	...
	<table class="min-w-full border border-gray-300 rounded">
		...
		@if($energyEs)
			...
			<tr>
				<td colspan="2" class="px-6 py-4 whitespace-normal"><b>Note:</b> Sums of squared IRs at receivers (coloured dots) when one emitter is active (blue cross). The position of the in-ear microphone is only indicated, because it is not known exactly.<br> 
			</td>
		@else
			<tbody><tr><td>No plots found</td></tr></tbody>
		@endif
	...
	<table class="min-w-full border border-gray-300 rounded">
		...
		<tr>
			<td colspan="1" class="px-6 py-4 whitespace-normal"><b>Note:</b> The position of the in-ear microphone is only indicated, because it is not known exactly.<br> 
		</td>
	</table>
</div>
